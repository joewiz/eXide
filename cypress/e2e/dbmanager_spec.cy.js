  ...
  describe("DB Manager operations", () => {
    ...
    it("should open the db manager", () => {
      ...
      cy.get("#open-dialog")
        ...
        .find(".eXide-dialog-title")
        .invoke("text")
        .should("eq", "DB Manager");
    });
    ...
    describe("resource properties for README.md", () => {
      it("should navigate to /db/apps/eXide and open properties for README.md", () => {
        ...
        cy.get("#resource-properties-dialog")
          .closest("dialog.eXide-dialog[open]")
          .should("be.visible");
        cy.get("#resource-properties-dialog")
          .closest("dialog.eXide-dialog[open]")
          .find(".eXide-dialog-title")
          .should("contain", "Resource/collection properties");
