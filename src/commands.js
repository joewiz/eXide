...
eXide.edit.commands = (function () {
  ...
  var nameLabels = {
    ...
    runQueryOrApp: "Run",
    openDocument: "Open",
    newDocumentFromTemplate: "New from Template",
    closeDocument: "Close",
    closeAll: "Close All",
    ...
    openTab: "Switch Editor",
    toggleQueryResults: "Toggle Results",
  ...
  function humanName(id) {
    ...
    return id.replace(/([a-z])([A-Z])/g, "$1 $2").replace(/^./, function (c) {
      ...
      if (xhr.status === 200) {
        ...
        (function () {
          ...
          addCommand(
            ...
            getKeyBinding(kb, "newDocumentFromTemplate"),
            function () {
