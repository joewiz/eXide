...
eXide.util.Preferences = (function () {
  ...
  Constr.prototype.updateForm = function () {
    ...
    form.querySelector('input[name="indent-on-download"]').checked =
      this.preferences.indentOnDownload;
    form.querySelector('input[name="indent-on-download-package"]').checked =
      this.preferences.indentOnDownloadPackage;
    form.querySelector('input[name="expand-xincludes-on-open"]').checked =
      this.preferences.expandXIncludesOnOpen;
    form.querySelector('input[name="expand-xincludes-on-download"]').checked =
      this.preferences.expandXIncludesOnDownload;
    form.querySelector('input[name="expand-xincludes-on-download-package"]').checked =
      this.preferences.expandXIncludesOnDownloadPackage;
    form.querySelector('input[name="omit-xml-decl-on-open"]').checked =
      this.preferences.omitXMLDeclarationOnOpen;
    form.querySelector('input[name="omit-xml-decl-on-download"]').checked =
      this.preferences.omitXMLDeclarationOnDownload;
    form.querySelector('input[name="omit-xml-decl-on-download-package"]').checked =
      this.preferences.omitXMLDeclarationOnDownloadPackage;
    ...
    form.querySelector('input[name="autocomplete-on-type"]').checked =
      this.preferences.autocompleteOnType !== false;
    ...
    form.querySelector('select[name="prettier-print-width"]').value =
      this.preferences.prettierPrintWidth;
    form.querySelector('input[name="prettier-single-quote"]').checked =
      this.preferences.prettierSingleQuote;
    form.querySelector('select[name="prettier-xml-ws"]').value =
      this.preferences.prettierXmlWhitespaceSensitivity;
    form.querySelector('input[name="prettier-xml-self-closing-space"]').checked =
      this.preferences.prettierXmlSelfClosingSpace;
    form.querySelector('input[name="prettier-xml-sort-attrs"]').checked =
      this.preferences.prettierXmlSortAttributesByKey;
    form.querySelector('select[name="prettier-xml-quote-attrs"]').value =
      this.preferences.prettierXmlQuoteAttributes;
    form.querySelector('input[name="prettier-single-attr-per-line"]').checked =
      this.preferences.prettierSingleAttributePerLine;
    form.querySelector('input[name="prettier-bracket-same-line"]').checked =
      this.preferences.prettierBracketSameLine;
    form.querySelector('input[name="prettier-bracket-spacing"]').checked =
      this.preferences.prettierBracketSpacing;
    form.querySelector('input[name="prettier-semi"]').checked = this.preferences.prettierSemi;
    form.querySelector('select[name="prettier-trailing-comma"]').value =
      this.preferences.prettierTrailingComma;
    form.querySelector('select[name="prettier-arrow-parens"]').value =
      this.preferences.prettierArrowParens;
    form.querySelector('select[name="prettier-prose-wrap"]').value =
      this.preferences.prettierProseWrap;
    form.querySelector('select[name="prettier-html-ws"]').value =
      this.preferences.prettierHtmlWhitespaceSensitivity;
  ...
  Constr.prototype.updatePreferences = function () {
    ...
    this.preferences.autocompleteOnType = form.querySelector(
      'input[name="autocomplete-on-type"]'
    ).checked;
    ...
    this.preferences.prettierPrintWidth = parseInt(
      form.querySelector('select[name="prettier-print-width"]').value,
      10
    );
    this.preferences.prettierSingleQuote = form.querySelector(
      'input[name="prettier-single-quote"]'
    ).checked;
    this.preferences.prettierXmlWhitespaceSensitivity = form.querySelector(
      'select[name="prettier-xml-ws"]'
    ).value;
    this.preferences.prettierXmlSelfClosingSpace = form.querySelector(
      'input[name="prettier-xml-self-closing-space"]'
    ).checked;
    this.preferences.prettierXmlSortAttributesByKey = form.querySelector(
      'input[name="prettier-xml-sort-attrs"]'
    ).checked;
    this.preferences.prettierXmlQuoteAttributes = form.querySelector(
      'select[name="prettier-xml-quote-attrs"]'
    ).value;
    this.preferences.prettierSingleAttributePerLine = form.querySelector(
      'input[name="prettier-single-attr-per-line"]'
    ).checked;
    this.preferences.prettierBracketSameLine = form.querySelector(
      'input[name="prettier-bracket-same-line"]'
    ).checked;
    this.preferences.prettierBracketSpacing = form.querySelector(
      'input[name="prettier-bracket-spacing"]'
    ).checked;
    this.preferences.prettierSemi = form.querySelector('input[name="prettier-semi"]').checked;
    this.preferences.prettierTrailingComma = form.querySelector(
      'select[name="prettier-trailing-comma"]'
    ).value;
    this.preferences.prettierArrowParens = form.querySelector(
      'select[name="prettier-arrow-parens"]'
    ).value;
    this.preferences.prettierProseWrap = form.querySelector(
      'select[name="prettier-prose-wrap"]'
    ).value;
    this.preferences.prettierHtmlWhitespaceSensitivity = form.querySelector(
      'select[name="prettier-html-ws"]'
    ).value;
    ...
    this.preferences.indentOnDownload = form.querySelector(
      'input[name="indent-on-download"]'
    ).checked;
    this.preferences.indentOnDownloadPackage = form.querySelector(
      'input[name="indent-on-download-package"]'
    ).checked;
    this.preferences.expandXIncludesOnOpen = form.querySelector(
      'input[name="expand-xincludes-on-open"]'
    ).checked;
    this.preferences.expandXIncludesOnDownload = form.querySelector(
      'input[name="expand-xincludes-on-download"]'
    ).checked;
    this.preferences.expandXIncludesOnDownloadPackage = form.querySelector(
      'input[name="expand-xincludes-on-download-package"]'
    ).checked;
    this.preferences.omitXMLDeclarationOnOpen = form.querySelector(
      'input[name="omit-xml-decl-on-open"]'
    ).checked;
    this.preferences.omitXMLDeclarationOnDownload = form.querySelector(
      'input[name="omit-xml-decl-on-download"]'
    ).checked;
    this.preferences.omitXMLDeclarationOnDownloadPackage = form.querySelector(
      'input[name="omit-xml-decl-on-download-package"]'
    ).checked;
  ...
  Constr.prototype.applyPreferences = function () {
    ...
    if (this.editor.editor) {
      ...
      if (this.editor._autoPairCompartment) {
        ...
        effects.push(
          this.editor._autoPairCompartment.reconfigure(
      ...
      if (this.editor._lineWrappingCompartment) {
        var wrap = this.preferences.softWrap;
        effects.push(
          this.editor._lineWrappingCompartment.reconfigure(
      ...
      if (this.editor._showInvisiblesCompartment) {
        ...
        effects.push(
          this.editor._showInvisiblesCompartment.reconfigure(
      ...
      if (this.editor._autocompletionCompartment) {
        effects.push(
          this.editor._autocompletionCompartment.reconfigure(
            CM6.autocompletion({
    ...
    document.querySelectorAll(".cm-editor").forEach(
      function (el) {
